...
<body>
    ...
    <table border="1">
        <tr>
            <td colspan="29" align="center"> <h3>DATA SEMUA NILAI</h3></td>
        </tr>
  <tr>
    <td><b>NO</b></td>
    <td><b>NAMA</b></td>
    ...
    <td colspan="4" align="center"><b>NILAI UN/US</b></td>
  ...
  <tr>
    ...
    <td colspan="4" align="center" style="color:black; background-color: #666;">NILAI</td>
  ...
  <tr>
    ...
    <td style="color:white; background-color: red;">IPS</td>
    ...
    <td style="color:white; background-color: blue;">IPS</td>
    ...
    <td style="color:black; background-color: yellow;">IPS</td>
    ...
    <td style="color:white; background-color: green;">IPS</td>
    ...
    <td style="color:black; background-color: pink;">IPS</td>

    <td style="color:black; background-color: #666;">IPA</td>
    <td style="color:black; background-color: #666;" >MAT</td>
    <td style="color:black; background-color: #666;">IND</td>
    <td style="color:black; background-color: #666;">IPS</td>
  ...
  <tr>
    ...
    <td style="color:white; background-color: #666;"><?php echo $row['ipa']; ?></td>
    <td style="color:white; background-color: #666;"><?php echo $row['matematika']; ?></td>
    <td style="color:white; background-color: #666;"><?php echo $row['bahasa_indonesia']; ?></td>
    <td style="color:white; background-color: #666;"><?php echo $row['bahasa_inggris']; ?></td>
    <?php $d6=NilaiUN($row['ipa'],$row['matematika'], $row['bahasa_indonesia'], $row['bahasa_inggris']);  ?>
   
    <td style="color:red;"><?php echo Nilai_Rata_Raport_UN($d1,$d2,$d3,$d4,$d5,$d6); ?></td>
  </tr>
    <?php $no ++; } ?>
</table>
</body>
